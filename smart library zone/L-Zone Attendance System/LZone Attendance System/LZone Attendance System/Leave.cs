...
namespace LZone_Attendance_System
{
    public partial class Leave : UserControl
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            cmd = new MySqlCommand("Update memberattendance SET LeaveTime='" + OutTime + "' where UserName='" + tb_QRcode.Text + "'", con);
            ...
            sda2 = new MySqlDataAdapter("Select * from memberattendance where UserName = '" + tb_QRcode.Text + "' ", con);
