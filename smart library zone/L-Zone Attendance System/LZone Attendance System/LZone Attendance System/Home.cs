...
namespace LZone_Attendance_System
{
    public partial class Home : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            LeaveTime = "Still at library.";
            cmd = new MySqlCommand("Insert into memberattendance values (@a,@c,@d,@f,@g)", con);
            ...
            sda2 = new MySqlDataAdapter("Select Date,UserName,BranchId,ArrivalTime from memberattendance where UserName = '" + userNm + "' ", con);
